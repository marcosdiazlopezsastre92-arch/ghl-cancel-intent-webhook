...
cases.push(
  ...
  leadOnly('G5-HARD-CANCEL', 'G5-008-no-sigamos', 'mejor no sigamos con esto', { expected: 'cancel_with_followup' }),
  ...
  leadOnly('G5-HARD-CANCEL', 'G5-021-stop', 'STOP', { expected: 'cancel_with_followup' }),
